    ...
    <svg class="main1" width="100%" height="100%">
      ...
      <g class="m1_stage" opacity="0">
        <g class="m1_cGroup">
          ...
          <g class="m1Orb orb4b">
            <image
              xlink:href="https://gcore.jsdelivr.net/gh/devicons/devicon/icons/vuejs/vuejs-original-wordmark.svg"
              width="40"
              height="40"
            />
          </g>
          ...
          <g class="m1Orb orb4">
            <image
              xlink:href="https://gcore.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original-wordmark.svg"
              width="40"
              height="40"
            />
          </g>
        ...
        <g class="m1_cGroup">
          ...
          <g class="m1Orb orb3c">
            <image
              xlink:href="https://gcore.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original-wordmark.svg"
              width="40"
              height="40"
            />
          </g>
          ...
          <g class="m1Orb orb3b">
            <image
              xlink:href="https://gcore.jsdelivr.net/gh/devicons/devicon/icons/python/python-original-wordmark.svg"
              width="40"
              height="40"
            />
          </g>
          <g class="m1Orb orb3">
            <image
              xlink:href="https://gcore.jsdelivr.net/gh/devicons/devicon/icons/fastapi/fastapi-original.svg"
              width="40"
              height="40"
            />
          </g>
        ...
        <g class="m1_cGroup">
          ...
          <g class="m1Orb orb2">
            <image
              xlink:href="https://gcore.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original-wordmark.svg"
              width="40"
              height="40"
            />
          </g>
        ...
        <g class="m1_cGroup">
          ...
          <g class="m1Orb orb1">
            <image
              xlink:href="https://gcore.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg"
              width="40"
              height="40"
            />
          </g>
